...
import { FUNNEL_LABELS } from "~/fsd/entities/analytics-event/model/funnels";
import type {
...
import type { AdminAnalyticsPageProps } from "../model/types";
...
function analyticsHref(range: AnalyticsDateRangeKey, funnel: FunnelId) {
  return `/admin/analytics?range=${range}&funnel=${funnel}`;
}
